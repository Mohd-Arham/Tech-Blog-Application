...
public class PostController {
	...
	public ResponseEntity<PostDto> createPost(@RequestBody 
			PostDto postDto,@PathVariable Integer userId, @PathVariable Integer categoryId){
	...
	public ResponseEntity<PostResponse> getAllPost(
			//hard coded value to using constatnts
	...
	public ResponseEntity<PostDto> uploadPostImage(@RequestParam("image") MultipartFile image
		...
		PostDto postDto = this.postService.getPostById(postId);
		String fileName = this.fileService.uploading(path, image);
	...
	public void downloadImage(@PathVariable("imageName") String imageName,
		...
		System.out.println("File Name 123123");
